    ...
    competencies: [
      {
        ...
        category: 'MIM製程技術執行',
        items: [
          { id: 'pe-1-1', name: '粉末射出成型製程參數設定', description: '依產品規格設定射出壓力、速度、溫度、保壓等製程參數，確保射出件尺寸與密度符合設計要求' },
          { id: 'pe-1-2', name: '脫脂製程控制', description: '執行溶劑脫脂與熱脫脂作業，監控脫脂時間、溫度曲線，確保黏結劑完全去除且生坯無裂紋變形' },
          { id: 'pe-1-3', name: '燒結爐程式設定與溫度管控', description: '設定燒結溫度曲線（升溫速率、燒結溫度、保溫時間、冷卻速率），確保金屬粉末充分緻密化，達到設計密度與機械性能' },
          { id: 'pe-1-4', name: '成品縮率預測與模具補償', description: '依粉末材料特性與製程條件預測燒結縮率，提出模具尺寸補償建議，配合模具廠進行修模驗證' },
        ]
      },
      {
        id: 'pe-2',
        category: '品質管制與異常分析',
        items: [
          { id: 'pe-2-1', name: '首件確認與製程中品質檢驗', description: '執行首件尺寸量測與外觀檢驗，制定製程中抽檢計畫，記錄量測數據，確保批次品質穩定' },
          { id: 'pe-2-2', name: '不良品根因分析', description: '彙整不良品類型（縮孔、裂紋、變形、燒結缺陷等），運用魚骨圖、5 Why等方法分析根因，提出並追蹤改善措施' },
          { id: 'pe-2-3', name: 'SPC管制圖建立與監控', description: '針對關鍵製程參數建立統計製程管制（SPC）圖，監控製程穩定性，超出管制界限時啟動異常處理程序' },
          { id: 'pe-2-4', name: '客訴品質問題調查與回覆', description: '接獲客訴後執行現品確認與製程追溯，配合品保課完成8D/CAPA報告，提供根因分析與改善計畫給客戶' },
        ]
      },
      {
        id: 'pe-3',
        category: '製程改善與文件管理',
        items: [
          { id: 'pe-3-1', name: '製程參數優化', description: '運用DOE（實驗設計）或田口法系統性優化製程參數，提升產品良率、縮短週期時間或降低製程成本' },
          { id: 'pe-3-2', name: 'SOP制定與更新', description: '依製程變更或改善結果即時更新標準作業程序，確保SOP反映最新製程狀態，並落實員工作業訓練' },
          { id: 'pe-3-3', name: '製程FMEA執行', description: '針對新產品或製程變更執行製程失效模式與影響分析（PFMEA），評估風險優先指數（RPN），制定預防管控措施' },
          { id: 'pe-3-4', name: '工程變更管理', description: '執行工程變更通知（ECN）作業，追蹤變更實施進度，確保相關文件、模具、製程參數及時同步更新' },
        ]
      },
      {
        id: 'pe-4',
        category: '設備維護與安全環境管理',
        items: [
          { id: 'pe-4-1', name: '射出機及週邊設備日常點檢', description: '依設備點檢表執行射出成型機、脫脂爐、燒結爐等設備日常巡檢，記錄異常狀況並啟動維修請修' },
          { id: 'pe-4-2', name: '設備異常排除', description: '判斷設備異常原因，執行基礎故障排除，超出能力範圍時協調設備廠商維修，確保設備快速復機' },
          { id: 'pe-4-3', name: '危害物質管理', description: '依法規管理脫脂溶劑（如正庚烷）及金屬粉末等危害物質，維護安全資料表（SDS），執行廢液與廢粉妥善處置' },
          { id: 'pe-4-4', name: '作業環境安全巡查', description: '定期執行作業環境安全巡查，識別危害因子，提出改善建議，確保作業人員符合個人防護裝備（PPE）佩戴規定' },
        ]
      },
      {
        id: 'pe-5',
        category: '現場指導與作業管理',
        items: [
          { id: 'pe-5-1', name: '現場技術指導', description: '對操作員進行製程操作示範與技術說明，確保現場人員正確執行射出、脫脂、燒結等作業，降低人為失誤率' },
          { id: 'pe-5-2', name: '工作指示能力', description: '清楚說明工作目標、作業步驟與品質要求，依人員能力分配任務，確保現場人員理解並確實執行指派工作' },
          { id: 'pe-5-3', name: '異常判斷與決策', description: '快速識別製程異常徵兆（設備報警、品質偏移、產能異常），評估影響範圍並即時做出處置決策，必要時啟動停機或升級通報' },
          { id: 'pe-5-4', name: '改善追蹤', description: '針對已提出的製程改善行動，定期追蹤執行進度與成效，記錄改善前後的量化指標，確認改善措施落實並持續有效' },
        ]
      },
      {
        id: 'pe-6',
        category: '溝通協調與回報能力',
        items: [
          { id: 'pe-6-1', name: '跨單位協調', description: '主動與品保、設備、生管、模具等相關部門溝通，協調資源與時程安排，確保製程問題獲得跨部門配合解決' },
          { id: 'pe-6-2', name: '現場溝通', description: '以清晰、適切的方式與現場作業員及班組長溝通製程要求與注意事項，聆聽現場反映並給予即時回應' },
          { id: 'pe-6-3', name: '衝突處理', description: '面對現場人員意見分歧或跨部門衝突，以客觀態度釐清問題根源，引導各方聚焦目標，尋求合理可行的解決方案' },
          { id: 'pe-6-4', name: '回報能力', description: '依規定時機與格式向上級彙報製程狀況、異常處理進度及改善結果，確保資訊即時、完整且重點清晰，利於主管決策' },
        ]
      },
    ]
  },
    ...
    competencies: [
      {
        ...
        category: '訂單處理與ERP管理',
        items: [
          { id: 'bl2-1-1', name: '訂單轉PI與ERP登打', description: '接收客戶原始訂單後轉成Proforma Invoice（PI）給客戶確認，客戶確認後打成ERP訂單與備忘錄下給生管，作為廠內安排生産之依據' },
          { id: 'bl2-1-2', name: '訂單驗貨聯繫', description: '客戶要求時聯繫第三方驗貨公司執行驗貨，確保出貨產品符合客戶品質規範' },
          { id: 'bl2-1-3', name: '產銷統計整理與彙報', description: '每週整理已出貨訂單與現有訂單統計，於下週一提供給主管，確保管理層掌握業務進度' },
        ]
      },
      {
        id: 'bl2-2',
        category: '出貨與物流管理',
        items: [
          { id: 'bl2-2-1', name: '出貨作業聯繫與執行', description: '執行貨代聯繫、報關行聯繫、貨櫃進出作業，確保出貨流程順暢、報關文件正確合規' },
          { id: 'bl2-2-2', name: '出貨訂單貨櫃資料整理', description: '整理可出貨且已拿到艙位的訂單資料，交給成倉安排貨櫃進出排程，確保出貨時效' },
        ]
      },
      {
        id: 'bl2-3',
        category: '財務帳款與法規申報',
        items: [
          { id: 'bl2-3-1', name: '客戶應收帳款對帳與請款', description: '每週執行應收帳款對帳、填寫收款單向客戶確認，配合A0122銀行系統上傳資料請款，確保帳款如期回收' },
          { id: 'bl2-3-2', name: '審核應付憑單', description: '每月5日前審核公司業務相關應付憑單，確認憑單正確性及合規性' },
          { id: 'bl2-3-3', name: '佣金預估與外銷快報', description: '每月25日完成PFM/NWR當月出貨佣金預估；每月5日前回報上一個月外銷金額給經濟部（外銷訂單快報）' },
        ]
      },
      {
        id: 'bl2-4',
        category: '客戶服務與合規管理',
        items: [
          { id: 'bl2-4-1', name: '客訴處理與回覆', description: '接獲客戶抱怨時下客訴單給品保及負責單位處理，追蹤改善進度，將結果回覆給客戶、總經理或董事長' },
          { id: 'bl2-4-2', name: '客戶滿意度調查', description: '每年12月20日前向前五大客戶進行滿意度問卷調查，彙整結果提供管理層改善參考' },
          { id: 'bl2-4-3', name: '外銷產品責任險管理', description: '每年6月10日前辦理外銷產品責任險續保或增保，確保公司出口業務的保險合規' },
        ]
      },
    ]
  },
    ...
    competencies: [
      {
        ...
        category: '訂單處理與ERP作業',
        items: [
          { id: 'ba-1-1', name: 'PI製作與ERP訂單登打', description: '有下訂單時計算貨物材積，製作PI（Proforma Invoice）給客戶確認，並於ERP登打訂單與備忘錄，作為廠內安排生産之依據' },
          { id: 'ba-1-2', name: '新訂單報價與追蹤管理', description: '辦理新訂單報價作業並持續追蹤管理，確保報價資訊正確且客戶及時收到' },
      ...
      },
      {
        ...
        category: '出貨文件與物流作業',
        items: [
          { id: 'ba-2-1', name: '出貨文件製作與VGM申報', description: '製作出貨文件（INVOICE & PACKING LIST）及VGM（貨物重量驗證）申報，確保文件正確完整，符合進出口報關要求' },
          { id: 'ba-2-2', name: '空運寄送作業', description: '執行空運配件寄送作業：打包配件、填寫貨運單、通知貨運公司來收貨，確保配件如期送達客戶' },
          { id: 'ba-2-3', name: '裝櫃照片整理上傳', description: '整理裝櫃照片後上傳至公司公槽及 BAND，留存出貨紀錄供查核' },
        ]
      },
      {
        id: 'ba-3',
        category: '客戶財務與帳款管理',
        items: [
          { id: 'ba-3-1', name: '結帳單整理與帳款催收', description: '定期整理客戶結帳單回傳財務，客戶匯款時登打應收帳款收款單，每週整理並追蹤催款明細紀錄' },
          { id: 'ba-3-2', name: '客戶抱怨受理與回應', description: '受理客戶抱怨，協調相關部門進行原因分析及改善，並對客戶進行正式回應，維護客戶關係' },
        ]
      },
      {
        id: 'ba-4',
        category: '配件包裝與品質協調',
        items: [
          { id: 'ba-4-1', name: '配件日常包裝作業', description: '每日執行配件包裝作業（約1小時），確保配件包裝符合出貨規格與品質要求' },
          { id: 'ba-4-2', name: '品質與交期協調', description: '有效掌握產品品質（驗貨）與交期，協調製造、品保等部門，確保如期如質交付，滿足客戶需求' },
        ]
      },
    ]
  },
