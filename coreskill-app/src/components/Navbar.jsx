...
export default function Navbar() {
  const { currentUser, logout, getUserNotifications, markNotificationRead, markAllNotificationsRead } = useAuth();
  ...
  return (
    <nav className="bg-white border-b border-gray-200 px-6 py-3 flex items-center justify-between shadow-sm sticky top-0 z-50">
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-base font-bold text-gray-900 leading-tight">CoreSkill Enterprise</h1>
          <p className="text-xs text-gray-500 leading-tight">核心技能訓練平台</p>
        </div>
      </div>
