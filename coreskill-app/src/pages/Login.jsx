...
const roleLabel = { employee: '員工', manager: '主管', admin: '管理員' };
        ...
        <div className="text-white text-center lg:text-left">
          <div className="flex items-center justify-center lg:justify-start gap-4 mb-6">
            <div className="w-16 h-16 bg-white rounded-2xl flex items-center justify-center shadow-xl">
              <span className="text-blue-600 font-black text-2xl">CS</span>
            </div>
            <div>
              <h1 className="text-3xl font-black leading-tight">CoreSkill</h1>
              <p className="text-blue-200 text-sm font-medium">Enterprise</p>
            </div>
          </div>
