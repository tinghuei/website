    ...
    competencies: [
      {
        ...
        category: '訂單與報價管理督導',
        items: [
          { id: 'bl2-1-1', name: '督導PI製作與ERP訂單登打', description: '督導業務助理計算貨物材積、製作PI（Proforma Invoice）給客戶確認，確認ERP訂單與備忘錄登打正確，作為廠內生産排程之依據' },
          { id: 'bl2-1-2', name: '督導新訂單報價與追蹤', description: '督導新訂單報價作業與追蹤管理，審查報價資訊正確性及時效，確保客戶及時收到準確報價' },
          { id: 'bl2-1-3', name: '訂單出貨進度管控與彙報', description: '掌控各訂單出貨進度，每週彙整出貨狀況提供予高階主管，確保出貨如期達成' },
        ]
      },
      {
        id: 'bl2-2',
        category: '出貨文件與物流督導',
        items: [
          { id: 'bl2-2-1', name: '督導出貨文件製作與VGM申報', description: '督導出貨文件（INVOICE & PACKING LIST）製作及VGM（貨物重量驗證）申報，確保文件正確完整，符合進出口報關要求' },
          { id: 'bl2-2-2', name: '督導空運與裝櫃出貨作業', description: '督導空運配件打包、貨運單填寫及通知貨運公司收貨，督導裝櫃照片整理上傳，確保出貨流程合規' },
        ]
      },
      {
        id: 'bl2-3',
        category: '客戶財務管理督導',
        items: [
          { id: 'bl2-3-1', name: '督導結帳單整理與帳款催收', description: '督導客戶結帳單整理並回傳財務，督導應收帳款收款單登打，每週追蹤催款明細紀錄，確保帳款如期回收' },
          { id: 'bl2-3-2', name: '客戶信用額度審查', description: '審查及管理客戶信用額度，評估交易風險，防範應收帳款呆帳，異常時即時回報主管' },
        ]
      },
      {
        id: 'bl2-4',
        category: '客戶服務與跨部門協調',
        items: [
          { id: 'bl2-4-1', name: '客戶抱怨受理與督導回應', description: '督導客戶抱怨之受理，協調製造、品保等部門原因分析及改善，確保客訴正式回應且問題解決，維護客戶關係' },
          { id: 'bl2-4-2', name: '品質驗貨與交期跨部門協調', description: '有效掌握各訂單品質（驗貨）與交期，協調製造、品保、資材等部門確保如期如質交付，滿足客戶需求' },
          { id: 'bl2-4-3', name: '人員管理與向上匯報', description: '分配並督導業務組員工作，追蹤執行成效，定期向主管彙報組別業務進展及異常狀況' },
        ]
      },
    ]
  },
