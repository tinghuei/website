...
export const TRAINING_REPORTS = [
  {
    ...
    userId: '1',
    courseId: 'c2',
    reportContent: '透過精實生產與5S管理課程，我深刻理解了工作環境整潔對生產效率的重要性。在實際工作中，我已開始實踐整理整頓的原則，將工具依使用頻率分類擺放，大幅減少了尋找工具的時間。七大浪費的概念也讓我重新審視自己的工作流程，找出並消除不必要的動作。',
    surveyRatings: {
      content: 5,
      instructor: 4,
      materials: 4,
    ...
    suggestions: '建議增加更多實際案例影片，讓學員更直觀地了解5S的執行過程。',
    submittedAt: '2024-03-25',
  },
  {
    id: 'r2',
    ...
    userId: '1',
    courseId: 'c4',
    reportContent: '多元文化職場溝通課程讓我對不同文化背景有了更深入的了解。身處有泰國、越南、印尼同事的工作環境，我之前常常因為溝通方式不同而產生誤解。透過課程學到的跨文化溝通技巧，我學會了如何用更清晰簡單的方式傳達訊息，並培養了對文化差異的尊重與包容。',
    surveyRatings: {
      content: 5,
      instructor: 5,
      materials: 4,
    ...
    overallSatisfaction: 5,
    suggestions: '建議加入語言學習資源，幫助台灣員工學習一些基本的東南亞語言問候語。',
    submittedAt: '2024-02-20',
  },
];
