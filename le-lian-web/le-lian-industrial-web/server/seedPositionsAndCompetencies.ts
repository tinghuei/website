...
/**
 * 初始化樂聯工業的所有職位與 iCAP 職能映射
 * 根據勞動部 iCAP 金屬製造業職能基準
 */
...
const positionCompetenciesMapping: Record<string, Array<{ competencyName: string; requiredLevel: number; importance: string }>> = {
  "廠務經理": [
    { competencyName: "人員管理", requiredLevel: 4, importance: "high" },
    { competencyName: "決策能力", requiredLevel: 4, importance: "high" },
    { competencyName: "領導力", requiredLevel: 4, importance: "high" },
    { competencyName: "計畫與組織", requiredLevel: 4, importance: "high" },
  ...
  "廠務副理": [
    { competencyName: "人員管理", requiredLevel: 3, importance: "high" },
    { competencyName: "決策能力", requiredLevel: 3, importance: "high" },
    { competencyName: "計畫與組織", requiredLevel: 3, importance: "high" },
  ...
  "廠務助理": [
    ...
    { competencyName: "設備維護", requiredLevel: 2, importance: "medium" },
    { competencyName: "溝通協調", requiredLevel: 2, importance: "medium" },
    { competencyName: "時間管理", requiredLevel: 2, importance: "low" },
  ],
  "設備工程師": [
    { competencyName: "設備維護", requiredLevel: 4, importance: "high" },
    { competencyName: "工藝改善", requiredLevel: 3, importance: "high" },
    { competencyName: "問題解決", requiredLevel: 3, importance: "high" },
    { competencyName: "持續學習", requiredLevel: 3, importance: "medium" },
    { competencyName: "溝通協調", requiredLevel: 2, importance: "medium" },
  ],
  "製造課長": [
    { competencyName: "人員管理", requiredLevel: 3, importance: "high" },
    { competencyName: "計畫與組織", requiredLevel: 3, importance: "high" },
    { competencyName: "品質檢驗", requiredLevel: 3, importance: "high" },
    { competencyName: "安全管理", requiredLevel: 3, importance: "high" },
    { competencyName: "決策能力", requiredLevel: 3, importance: "medium" },
    { competencyName: "溝通協調", requiredLevel: 3, importance: "medium" },
  ],
  "製造副課長": [
    { competencyName: "人員管理", requiredLevel: 2, importance: "high" },
    { competencyName: "計畫與組織", requiredLevel: 2, importance: "high" },
    { competencyName: "品質檢驗", requiredLevel: 2, importance: "high" },
    { competencyName: "安全管理", requiredLevel: 2, importance: "high" },
    { competencyName: "溝通協調", requiredLevel: 2, importance: "medium" },
  ],
  "技術員": [
    { competencyName: "機械操作", requiredLevel: 3, importance: "high" },
    { competencyName: "安全管理", requiredLevel: 3, importance: "high" },
    { competencyName: "品質檢驗", requiredLevel: 2, importance: "medium" },
    { competencyName: "團隊合作", requiredLevel: 2, importance: "medium" },
  ],
  "班長": [
    { competencyName: "人員管理", requiredLevel: 2, importance: "high" },
    { competencyName: "機械操作", requiredLevel: 3, importance: "high" },
  ...
  "資材課長": [
    { competencyName: "庫存管理", requiredLevel: 3, importance: "high" },
    { competencyName: "計畫與組織", requiredLevel: 3, importance: "high" },
    { competencyName: "人員管理", requiredLevel: 2, importance: "medium" },
    { competencyName: "成本控制", requiredLevel: 3, importance: "high" },
    { competencyName: "溝通協調", requiredLevel: 2, importance: "medium" },
  ],
  "資材副課長": [
    { competencyName: "庫存管理", requiredLevel: 2, importance: "high" },
    { competencyName: "計畫與組織", requiredLevel: 2, importance: "high" },
  ...
  "生管": [
    { competencyName: "計畫與組織", requiredLevel: 3, importance: "high" },
    { competencyName: "溝通協調", requiredLevel: 2, importance: "medium" },
    { competencyName: "問題解決", requiredLevel: 2, importance: "medium" },
  ],
  "物管": [
    { competencyName: "庫存管理", requiredLevel: 3, importance: "high" },
    { competencyName: "計畫與組織", requiredLevel: 2, importance: "medium" },
    { competencyName: "溝通協調", requiredLevel: 2, importance: "medium" },
  ],
  "成倉": [
    { competencyName: "庫存管理", requiredLevel: 2, importance: "high" },
  ...
  "採購助理": [
    { competencyName: "採購管理", requiredLevel: 1, importance: "high" },
    { competencyName: "溝通協調", requiredLevel: 2, importance: "medium" },
    { competencyName: "時間管理", requiredLevel: 2, importance: "low" },
  ],
  "採購專員": [
    { competencyName: "採購管理", requiredLevel: 3, importance: "high" },
    { competencyName: "成本控制", requiredLevel: 2, importance: "high" },
    { competencyName: "溝通協調", requiredLevel: 3, importance: "medium" },
    { competencyName: "問題解決", requiredLevel: 2, importance: "medium" },
  ],
  "品保課課長": [
    { competencyName: "品質檢驗", requiredLevel: 4, importance: "high" },
    { competencyName: "人員管理", requiredLevel: 3, importance: "high" },
    { competencyName: "工藝改善", requiredLevel: 3, importance: "high" },
    { competencyName: "決策能力", requiredLevel: 3, importance: "medium" },
    { competencyName: "溝通協調", requiredLevel: 3, importance: "medium" },
  ...
  "品保課副課長": [
    { competencyName: "品質檢驗", requiredLevel: 3, importance: "high" },
    { competencyName: "工藝改善", requiredLevel: 2, importance: "high" },
    { competencyName: "溝通協調", requiredLevel: 2, importance: "medium" },
  ],
  "品檢員": [
    { competencyName: "品質檢驗", requiredLevel: 3, importance: "high" },
  ...
  "總務課課長": [
    { competencyName: "人員管理", requiredLevel: 3, importance: "high" },
    { competencyName: "計畫與組織", requiredLevel: 3, importance: "high" },
    { competencyName: "決策能力", requiredLevel: 2, importance: "medium" },
    { competencyName: "溝通協調", requiredLevel: 3, importance: "medium" },
  ],
  "總務課副課長": [
    { competencyName: "人員管理", requiredLevel: 2, importance: "high" },
  ...
  "庶務員": [
    { competencyName: "時間管理", requiredLevel: 2, importance: "medium" },
    { competencyName: "溝通協調", requiredLevel: 1, importance: "low" },
  ],
  "清潔員": [
    { competencyName: "安全管理", requiredLevel: 1, importance: "high" },
    { competencyName: "時間管理", requiredLevel: 1, importance: "medium" },
  ],
  "業務課組長": [
    { competencyName: "人員管理", requiredLevel: 2, importance: "high" },
  ...
  "業務助理": [
    { competencyName: "客戶服務", requiredLevel: 2, importance: "high" },
    { competencyName: "溝通協調", requiredLevel: 2, importance: "medium" },
  ],
  "業務專員": [
    { competencyName: "客戶服務", requiredLevel: 3, importance: "high" },
  ...
  "研發課課長": [
    { competencyName: "產品開發", requiredLevel: 4, importance: "high" },
    { competencyName: "人員管理", requiredLevel: 3, importance: "high" },
    { competencyName: "工藝改善", requiredLevel: 3, importance: "high" },
    { competencyName: "決策能力", requiredLevel: 3, importance: "medium" },
  ],
  "研發課副課長": [
    { competencyName: "產品開發", requiredLevel: 3, importance: "high" },
    { competencyName: "工藝改善", requiredLevel: 2, importance: "high" },
  ],
  "研發工程師": [
    { competencyName: "產品開發", requiredLevel: 3, importance: "high" },
  ...
  "營業部經理": [
    ...
    { competencyName: "領導力", requiredLevel: 4, importance: "high" },
    { competencyName: "溝通協調", requiredLevel: 4, importance: "medium" },
  ],
  "文官中心": [
    { competencyName: "計畫與組織", requiredLevel: 2, importance: "high" },
    { competencyName: "溝通協調", requiredLevel: 2, importance: "medium" },
...
export async function seedPositionsAndCompetencies() {
  ...
  try {
    ...
    // 1. 插入職位
    console.log("插入職位...");
    const insertedPositions: Record<string, number> = {};
    for (const pos of positionsData) {
      const result = await db.insert(jobPositions).values(pos);
      // Get the inserted ID
      const { eq } = require('drizzle-orm');
      const positions = await db.select().from(jobPositions).where(
        eq(jobPositions.name, pos.name)
      );
      if (positions.length > 0) {
        insertedPositions[pos.name] = positions[0].id;
      }
    }
    console.log(`成功插入 ${Object.keys(insertedPositions).length} 個職位`);

    // 2. 插入職能
    console.log("插入職能...");
    const insertedCompetencies: Record<string, number> = {};
    for (const comp of competenciesData) {
      const result = await db.insert(competencies).values(comp);
      // Get the inserted ID
      const { eq } = require('drizzle-orm');
      const comps = await db.select().from(competencies).where(
        eq(competencies.name, comp.name)
      );
      if (comps.length > 0) {
        insertedCompetencies[comp.name] = comps[0].id;
      }
    }
    console.log(`成功插入 ${Object.keys(insertedCompetencies).length} 個職能`);

    // 3. 插入職位職能映射
    console.log("插入職位職能映射...");
    let mappingCount = 0;
    for (const [positionName, competencyList] of Object.entries(positionCompetenciesMapping)) {
      const positionId = insertedPositions[positionName];
      if (!positionId) {
      ...
      for (const comp of competencyList) {
        const competencyId = insertedCompetencies[comp.competencyName];
        if (!competencyId) {
          console.warn(`找不到職能: ${comp.competencyName}`);
          continue;
        }
    ...
    console.log(`成功插入 ${mappingCount} 個職位職能映射`);
